...
translations = {
    'en': {
        ...
        'Establishment_name': 'Toulouse Cancer Research Center (CRCT)',
        'Email': 'Email',
        'Languages': 'Languages',
        ...
        'Stat4_title': 'Experience',
        'Stat4_meaning': 'Months experience in bioinformatics',
        'Stats': 'Stats',
        'Skills': 'Skills',
        ...
        'Skill_1': 'Single-cell RNA-seq analysis',
        'Skill_2': 'Spatial transcriptomics (10X Visium)',
        'Skill_3': 'Multi-omics data integration',
        'Skill_4': 'Tumor microenvironment profiling',
        'Skill_5': 'Statistical modeling & biomarker discovery',
        'Skill_6': "R (Seurat, Bioconductor) & Python (Scanpy, scikit-learn)",
        'Skill_7': 'Reproducible pipelines (Nextflow, HPC)',
        'Skill_8': 'Docker, Git & UNIX environments',
        ...
        'Prof_experience_name_5': 'Bioinformatics Research Engineer',
        'Prof_experience_establishment_5': 'CRCT (Inserm Research Center of Toulouse), GENIM Team, Toulouse',
        'Prof_experience_duration_5': 'January 2026 - Present',
        'Prof_experience_description_5_skill_1': 'Leading the development of a comprehensive bioinformatics pipeline for multi-omics data integration and analysis in cancer research.',
        'Prof_experience_description_5_skill_2': 'Collaborating with multidisciplinary teams to design and implement computational workflows, ensuring reproducibility and scalability of analyses.',
    ...
    'fr': {
        ...
        'Establishment_name': 'Centre de Recherche en Cancérologie de Toulouse (CRCT)',
        'Email': 'Email',
        'Languages': 'Langues',
        ...
        'Stat4_title': 'Expérience',
        'Stat4_meaning': 'Mois d\'expérience en bioinformatique',
        'Skills': 'Compétences',
        ...
        'Prof_experience_name_5': 'Ingénieur d\'étude hospitalier en Bioinformatique',
        'Prof_experience_establishment_5': 'CRCT (Centre de Recherche en Cancérologie de Toulouse), Équipe GENIM, Toulouse',
        'Prof_experience_duration_5': 'Janvier 2026 - Présent',
        'Prof_experience_description_5_skill_1': "Direction du développement d'un pipeline bioinformatique complet pour l'intégration et l'analyse de données multi-omics en recherche sur le cancer.",
        'Prof_experience_description_5_skill_2': "Collaboration avec des équipes multidisciplinaires pour concevoir et mettre en œuvre des flux de travail computationnels, assurant la reproductibilité et la scalabilité des analyses.",
